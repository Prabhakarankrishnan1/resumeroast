...
export async function POST(request) {
  try {
    ...
    const personaPrompts = {
      kind: "You are a warm, encouraging career coach who gives constructive feedback with empathy." + JSON_REMINDER,
      tough: "You are a strict hiring manager at a Fortune 500 company with very high standards." + JSON_REMINDER,
      brutal: "You are a brutally honest friend who is funny, sarcastic, and blunt but ultimately helpful." + JSON_REMINDER,
    };
