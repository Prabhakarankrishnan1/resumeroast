...
export default function SkillPrint() {
  ...
  const handleShare = async () => {
    const text = `My SkillPrint: I'm ${skillData!.marketReadinessScore}% ready for ${targetRole}! 🎯 Check yours at www.resumeroast.in/skillprint`;
    try {
          ...
          const handleCopyRoadmap = async () => {
            const lines = [
              ...
              skillData.estimatedTimeToTarget
                ...
                : "",
              "Generated by SkillPrint at www.resumeroast.in/skillprint",
          ...
          >
            ...
            >
              ...
              <p style={{ margin: 0, fontSize: "13px", color: "#64748b" }}>
                Get yours at{" "}
                <span style={{ color: "#0d9488", fontWeight: 700 }}>www.resumeroast.in/skillprint</span>
              </p>
            </div>
